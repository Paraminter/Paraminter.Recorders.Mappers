...
public sealed class BoolDelegateMappedArgumentDataRecorderFactory : IBoolDelegateMappedArgumentDataRecorderFactory
{
    ...
    IMappedArgumentDataRecorder<TRecord, TArgumentData> IBoolDelegateMappedArgumentDataRecorderFactory.Create<TRecord, TArgumentData>(DBoolArgumentDataRecorder<TRecord, TArgumentData> recorderDelegate)
    {
    ...
    private sealed class MappedArgumentRecorder<TRecord, TArgumentData> : IMappedArgumentDataRecorder<TRecord, TArgumentData>
    {
        ...
        public MappedArgumentRecorder(DBoolArgumentDataRecorder<TRecord, TArgumentData> recorderDelegate)
        {
