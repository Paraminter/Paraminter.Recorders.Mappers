...
/// <inheritdoc cref="ISemanticRecorderLogger{TCategoryName}"/>
public sealed class SemanticRecorderLogger<TCategoryName> : ISemanticRecorderLogger<TCategoryName>
{
    ...
    /// <summary>Instantiates a <see cref="SemanticRecorderLogger{TCategoryName}"/>, handling logging for <see cref="ISemanticRecorder"/>.</summary>
    /// <param name="logger">The logger used to log messages.</param>
    public SemanticRecorderLogger(ILogger<TCategoryName> logger)
    {
        if (logger is null)
        {
    ...
    ITypeArgumentLogger ISemanticRecorderLogger.TypeArgument => TypeArgument;
    IConstructorArgumentLogger ISemanticRecorderLogger.ConstructorArgument => ConstructorArgument;
    INamedArgumentLogger ISemanticRecorderLogger.NamedArgument => NamedArgument;
