...
/// <inheritdoc cref="ISyntacticRecorderLogger{TCategoryName}"/>
public sealed class SyntacticRecorderLogger<TCategoryName> : ISyntacticRecorderLogger<TCategoryName>
{
    ...
    /// <summary>Instantiates a <see cref="SyntacticRecorderLogger{TCategoryName}"/>, handling logging for <see cref="ISyntacticRecorder"/>.</summary>
    /// <param name="logger">The logger used to log messages.</param>
    public SyntacticRecorderLogger(ILogger<TCategoryName> logger)
    {
        if (logger is null)
        {
    ...
    ITypeArgumentsLogger ISyntacticRecorderLogger.TypeArgument => TypeArgument;
    IConstructorArgumentsLogger ISyntacticRecorderLogger.ConstructorArgument => ConstructorArgument;
    INamedArgumentsLogger ISyntacticRecorderLogger.NamedArgument => NamedArgument;
